...
## 1. /ask endpoint - This endpoints provide response generated by RAG AI Agent
...
```
## 2. /v0/ask endpoint - This endpoints provide response generated by Simple Azure OpenAI that using Function Calling to fetch documents
Run the following CURL command to test the /ask endpoint:
```
curl -X POST "https://domain/v0/ask" -H "Content-Type":"application/json" -d '{"question":"who is acmecloud?","session_id":"user123"}'    
```
